  ...
  return (
    <div className="landing-page">
      ...
      <nav className="landing-nav">
        <div className="nav-logo" onClick={() => setShowFeatures(false)} style={{ cursor: 'pointer' }}>
      ...
      {showFeatures ? (
        /* Features Grid */
        <section id="features" className="landing-features" style={{ minHeight: 'calc(100vh - 280px)', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          <div style={{ display: 'flex', width: '100%', maxWidth: '1200px', margin: '0 auto 24px auto' }}>
            <button className="btn-hero-secondary" onClick={() => setShowFeatures(false)} style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '10px 20px', fontSize: '14px' }}>
        ...
        /* Hero Section */
        <header className="landing-hero" style={{ minHeight: 'calc(100vh - 280px)', display: 'flex', alignItems: 'center' }}>
          <div className="hero-content">
            ...
            <div className="hero-cta-group">
              ...
              <button className="btn-hero-secondary" onClick={() => setShowFeatures(true)}>Explore Features</button>
            </div>
          </div>
